...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\User\Khazprokhir\public\storage' => 'string',
            ...
            'permissions.modules.receiving' => 'string',
            'permissions.modules.sorting' => 'string',
            'permissions.modules.packaging' => 'string',
            'permissions.modules.bi_submission' => 'string',
            'permissions.modules.targets' => 'string',
            'permissions.modules.reports' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\User\\Khazprokhir\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','permissions.modules.receiving',
'permissions.modules.sorting','permissions.modules.packaging','permissions.modules.bi_submission','permissions.modules.targets','permissions.modules.reports',
...
'web','api',);
        registerArgumentsSet('routes', 'dashboard','batch-tracking.index','reports.index',
'reports.export','reports.print','profile.edit','profile.update','profile.destroy',
'hcs-receiving.create','hcs-receiving.store','hcs-receiving.edit','hcs-receiving.update','hcs-receiving.destroy',
'hcs-receiving.index','rekomendasi-penerimaan.index','rekomendasi-penerimaan.print','rekomendasi-penerimaan.export','rekomendasi-penerimaan.show',
'hcs-sorting.create','hcs-sorting.store','hcs-sorting.index','rekomendasi-penyortiran.index','hcs-sorting-reports.index',
'hcs-sorting-reports.export','hcs-sorting-reports.print','hcs-sorting-reports.edit','hcs-sorting-reports.update','hcs-sorting-reports.destroy',
'packs.used','pengemasan.create','pengemasan.store','pengemasan.destroy','pengemasan.index',
'pengemasan.data','pengemasan.export','pengemasan.print','pengemasan.show','penyerahan-bi.index',
'penyerahan-bi.create','penyerahan-bi.store','penyerahan-bi.edit','penyerahan-bi.update','penyerahan-bi.destroy',
'penyerahan-bi.export','penyerahan-bi.print','penyerahan-bi.check-duplicate','laporan-harian.index','laporan-harian.print',
'laporan-harian.export','targets.index','targets.create','targets.store','targets.edit',
'targets.update','targets.destroy','hcts-receiving.create','hcts-receiving.store','hcts-receiving.get-hcs-total',
'hcts-receiving.edit','hcts-receiving.update','hcts-receiving.destroy','hcts-receiving.export','hcts-receiving.print',
'hcts-receiving.index','hcts-receiving.summary-export','hcts-receiving.summary-print','hcts-receiving.summary','hcts-submission.create',
'hcts-submission.store','hcts-submission.edit','hcts-submission.update','hcts-submission.destroy','hcts-submission.available-batches',
'hcts-submission.export','hcts-submission.print','hcts-submission.index','hcts-inventory.export','hcts-inventory.print',
'hcts-inventory.index','hcts-inventory.batch-detail','register','login','password.request','password.email','password.reset','password.store',
...
'auth.verify-email','batch-tracking.index','components.application-logo','components.auth-session-status','components.danger-button',
...
'dashboard','hcs-receiving.create','hcs-receiving.edit','hcs-receiving.index','hcs-receiving.rekomendasi.index',
'hcs-receiving.rekomendasi.print','hcs-receiving.rekomendasi.show','hcs-sorting-report.edit','hcs-sorting-report.index','hcs-sorting-report.print',
'hcs-sorting.create','hcs-sorting.index','hcts-inventory.index','hcts-inventory.print','hcts-receiving.create',
'hcts-receiving.edit','hcts-receiving.index','hcts-receiving.print','hcts-receiving.summary','hcts-receiving.summary-print',
'hcts-submission.create','hcts-submission.edit','hcts-submission.index','hcts-submission.print','laporan-harian.index',
'laporan-harian.print','laporan-harian.print-operasional','layouts.app','layouts.guest','layouts.navigation',
'pengemasan.create','pengemasan.data','pengemasan.index','pengemasan.print','pengemasan.show',
'penyerahan-bi.create','penyerahan-bi.edit','penyerahan-bi.index','penyerahan-bi.print','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','rekomendasi-penyortiran.index','reports.index',
'reports.print','targets.create','targets.edit','targets.index','users.create',
'users.edit','users.index','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.Users.User.Khazprokhir.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','BCRYPT_ROUNDS',
'LOG_CHANNEL','LOG_STACK','DB_CONNECTION','SESSION_DRIVER','SESSION_LIFETIME',
