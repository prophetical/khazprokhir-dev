<x-app-layout>
    ...
    <div class="py-4 text-[10px]" x-data="hcsKhazaiForm()" x-init="init()">
                    ...
                    <div class="lg:col-span-4 space-y-4">
                        <div class="bg-white p-5 rounded-2xl shadow-xl border border-gray-100 flex flex-col gap-4">
                            ...
                            <div class="space-y-3">
                                <div>
                                    <label
                                        class="block font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Nomor
                                        Bon</label>
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        <label
                                            class="block font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Tanggal</label>
                                    ...
                                    <div>
                                        <label
                                            class="block font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Batch</label>
                                ...
                                <div class="grid grid-cols-3 gap-3">
                                    <div>
                                        <label
                                            class="block font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Pecahan</label>
                                        <div class="relative">
                                    ...
                                    <div>
                                        <label
                                            class="block font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Seri</label>
                                        <input type="text" id="seri" name="seri" required
                                            x-on:input="handleSeriInput($event)" x-model="formData.seri"
                                            :readonly="isLocked"
                                            :class="isLocked ? 'bg-gray-50 border-gray-100 text-gray-400 cursor-not-allowed' : ''"
                                            class="w-full border-gray-200 rounded-lg font-bold py-2 px-3 text-xs focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all shadow-sm text-center uppercase"
                                            placeholder="XX-XX#">
                                    </div>
                                    <div>
                                        <label
                                            class="block font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">TE</label>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    <label
                                        class="block font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Gilir</label>
                                ...
                                <div>
                                    <label
                                        class="block font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">TA</label>
                                    <div class="relative">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    <label
                                        class="block font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Mesin</label>
                                ...
                                <div>
                                    <label
                                        class="block font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Supplier</label>
                        ...
                        <div class="bg-white p-5 rounded-2xl shadow-xl border border-gray-100 space-y-4 h-full">
                            <div class="flex items-center justify-between mb-1">
                                <div class="flex items-center gap-2">
                                    ...
                                    <h3 class="text-xs font-black text-gray-900 uppercase tracking-widest">Detail Pack
                                    </h3>
                                </div>
                                <div
                            ...
                            <div
                                class="grid grid-cols-2 gap-4 items-end bg-slate-50 p-4 rounded-xl border border-slate-100">
                                <div>
                                    <label
                                        class="block font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Jumlah
                                        Bilyet Total</label>
                                ...
                                <div class="flex items-center justify-center gap-4">
                                    <div class="text-center">
                                        <p
                                            ...
                                            Estimasi Pack</p>
                                        <p class="text-xl font-black text-emerald-700 leading-none"
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-1.5">
                                    <div class="w-3 h-3 bg-green-300 rounded shadow-xs border border-green-400/20">
                                    </div>
                            ...
                            <div class="mt-2 border-t border-gray-50 pt-3 relative">
                                ...
                                <p
                                    class="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-2 flex items-center justify-between">
                                    <span>Pilih Nomor Pack</span>
                                    <span x-show="formData.batch && formData.seri"
                                        class="text-[8px] text-indigo-400 normal-case font-bold"
                                        x-text="'Ref: ' + formData.batch + ' ' + formData.seri"></span>
                                </p>

                                <div class="grid grid-flow-col grid-rows-10 gap-1.5 overflow-x-auto pb-2 min-h-[350px]">
                                    <template x-for="n in 100">
                                        <div @click="togglePack(n)" :class="getPackClass(n)"
        ...
        function hcsKhazaiForm() {
            return {
                ...
                handleJumlahInput(e) {
                    ...
                    this.formData.jumlah = rawValue === '' ? 0 : parseInt(rawValue);
