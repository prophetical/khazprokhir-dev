                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <input id="jumlah_display" type="tel" 
                                                   ...
                                                   :class="currentTheme ? (currentTheme.focus + ' ' + currentTheme.ring) : 'focus:border-indigo-500 focus:ring-indigo-500'" 
                                                   value="{{ old('jumlahDisplay') }}" required />
                                        ...
                                        <div>
                                            ...
                                            <input id="batch" name="batch" type="text" maxlength="7" 
                                                   class="mt-1 block w-full font-mono uppercase border-gray-300 rounded-md shadow-sm transition-all duration-300"
                                                   :class="currentTheme ? (currentTheme.focus + ' ' + currentTheme.ring) : 'focus:border-indigo-500 focus:ring-indigo-500'" 
                                                   value="{{ old('batch', request('batch')) }}" required />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input id="seri" name="seri" type="text" 
                                                   class="mt-1 block w-full font-mono uppercase border-gray-300 rounded-md shadow-sm transition-all duration-300"
                                                   :class="currentTheme ? (currentTheme.focus + ' ' + currentTheme.ring) : 'focus:border-indigo-500 focus:ring-indigo-500'" 
                                                   placeholder="AA-BB7" value="{{ old('seri', request('seri')) }}" required />
                                        </div>
