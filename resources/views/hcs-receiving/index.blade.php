                                            ...
                                            <td class="px-2 py-4 sm:px-4 whitespace-nowrap text-center text-[10px] sm:text-sm font-medium">
                                                @if(in_array(auth()->user()->role, ['sortir', 'admin']))
                                                    ...
                                                    <div class="flex justify-center items-center space-x-3">
                                                        @if($receiving->barcode_token)
                                                            <a href="{{ route('hcs-receiving.history', $receiving->barcode_token) }}"
                                                                class="text-amber-500 hover:text-amber-700 transition-all hover:scale-110"
                                                        ...
                                                        @endif
                                                        <a href="{{ route('hcs-receiving.create', ['batch' => $receiving->batch, 'seri' => $receiving->seri, 'pecahan' => $receiving->pecahan, 'emisi' => $receiving->emisi, 'tahun_anggaran' => $receiving->tahun_anggaran]) }}"
                                                            class="text-green-600 hover:text-green-800 transition-all hover:scale-110"
                                                            title="Input di batch ini">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor"
