<x-app-layout>
    ...
    <div id="main-wrapper" class="py-10 min-h-screen bg-[#f8fafc] dark:bg-slate-900 transition-colors duration-500" x-data="sortingGrid()">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="flex-1">
                    <div class="bg-white dark:bg-slate-800/50 rounded-3xl shadow-xl shadow-slate-200/60 border border-slate-100 dark:border-slate-700/50 overflow-hidden group">
                        <!-- Card Header -->
                        ...
                        <div class="p-8">
                            ...
                            <div class="relative group/grid bg-slate-100/30 dark:bg-slate-950/40 p-4 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-inner overflow-x-auto lg:overflow-visible">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                <div class="bg-gradient-to-br from-indigo-500 to-indigo-700 p-4 rounded-2xl text-white relative overflow-hidden group">
                                    ...
                                    <div class="relative z-10">
                                        <p class="text-[9px] font-bold text-white/70 uppercase tracking-widest">Pilihan Aktif</p>
                                ...
                                <div class="bg-gradient-to-br from-emerald-500 to-emerald-700 p-4 rounded-2xl text-white relative overflow-hidden group">
                                    <div class="absolute -right-4 -bottom-4 w-24 h-24 bg-white/10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-700"></div>
                                    <div class="relative z-10">
                                        <p class="text-[9px] font-bold text-white/70 uppercase tracking-widest">Total Bilyet</p>
                                        <div class="mt-0.5">
                                            <span class="text-xl font-black tracking-tight" x-text="formatNumber(totalBilyet)"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
