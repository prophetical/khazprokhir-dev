...
<body class="p-4 md:p-10">
    <div
        ...
        <div class="no-print flex justify-between items-center mb-8 pb-6 border-b border-gray-100">
            <a href="{{ route('hcs-sorting-reports.index', request()->all()) }}"
            ...
            <div class="border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                <table class="w-full text-left border-collapse table-tight">
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        ...
                        @forelse($reports as $row)
                            <tr>
                                <td class="text-[10px] font-medium text-gray-600">
                                    {{ $row->tanggal_sortir->locale('id')->isoFormat('D MMMM YYYY') }}</td>
                                ...
                                <td class="text-[10px] font-bold text-green-700 text-right">
                        ...
                        @empty
                            <tr>
                                <td colspan="11" class="text-center py-10 text-gray-400 text-sm italic">Tidak ada data
                    ...
                    <tfoot class="bg-gray-50 border-t border-gray-200">
                        <tr>
                            ...
                            <td class="text-[10px] font-extrabold text-gray-900 text-right p-3">
                                {{ number_format($reports->sum('jumlah_pack'), 0, ',', '.') }}</td>
                            <td class="text-[10px] font-extrabold text-green-700 text-right p-3">
                                {{ number_format($reports->sum('jumlah_bilyet'), 0, ',', '.') }}</td>
                            <td></td>
                        </tr>
                    </tfoot>
                </table>
