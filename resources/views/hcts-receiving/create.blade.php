                                                ...
                                                <div>
                                                    ...
                                                    <select id="pecahan" name="pecahan" x-model="selectedPecahan"
                                                        ...
                                                        @foreach(['S' => '1.000', 'T' => '2.000', 'U' => '5.000', 'V' => '10.000', 'W' => '20.000', 'X' => '50.000', 'Y' => '100.000'] as $key => $val)
                                                            <option value="{{ $key }}" class="bg-white text-gray-900" {{ old('pecahan') == $key ? 'selected' : '' }}>{{ $key }}
                                                                ({{ $val }})</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div>
                                                    ...
                                                    <select id="gilir" name="gilir"
                                                        ...
                                                        @foreach(['Gilir 1', 'Gilir 2', 'Gilir 3'] as $g)
                                                            <option value="{{ $g }}" {{ old('gilir') == $g ? 'selected' : '' }}>{{ $g }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
                                            ...
                                            <div class="md:col-span-7 space-y-2">
                                                <div class="flex justify-between items-end mb-1">
                                                    <div>
                                                        <p class="text-[10px] font-bold text-gray-400">Akumulasi Batch
                                                        </p>
                                                        <p class="text-sm font-black"
                                                            ...
                                                            <span class="text-emerald-500 font-bold">/ 4.500.000</span>
                                                        </p>
                                                    </div>
