<x-app-layout>
                ...
                <div class="p-4 text-gray-900">
                    ...
                    <div x-data="hctsEditData({
                        ...
                        <div class="mb-4 flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                <div class="bg-rose-600 p-3 rounded-2xl"
                                    :class="currentTheme ? currentTheme.btn : 'bg-rose-600 shadow-rose-200'">
                                ...
                                <div>
                                    <h3 class="text-xl font-black text-gray-900 uppercase tracking-tighter">Edit Data
                                        HCTS</h3>
                                    <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">Sistem
                                        Pengelolaan HCTS — Khazprokhir</p>
                                </div>
                            </div>
                        </div>
                        ...
                        @if ($errors->any())
                            <div class="mb-4 p-4 bg-rose-50 border-l-4 border-rose-500 rounded-2xl">
                                <div class="flex items-center mb-2">
                                    ...
                                    <p class="text-sm font-black text-rose-700 uppercase tracking-widest">Terdapat Kesalahan
                                        Input</p>
                                </div>
                        ...
                        <div class="bg-gray-50/50 p-6 rounded-[2rem] border transition-all duration-500"
                            ...
                            <form action="{{ route('hcts-receiving.update', $hcts_receiving->id) }}" method="POST"
                                class="space-y-6">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="lg:col-span-4 space-y-6">
                                        <div
                                            ...
                                            <div class="flex items-center gap-3 mb-6">
                                                ...
                                                <span
                                                    class="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Administrasi</span>
                                            </div>

                                            <div class="space-y-4">
                                                <div class="relative group">
                                                    <x-input-label for="nomor_bon" value="Nomor Bon"
                                                        class="text-[10px] font-black uppercase text-gray-400 tracking-widest mb-1 ml-1" />
                                                    <x-text-input id="nomor_bon" name="nomor_bon" type="text"
                                                        ...
                                                        value="{{ old('nomor_bon', $hcts_receiving->nomor_bon) }}"
                                                        required />
                                                </div>
                                                <div class="relative group">
                                                    ...
                                                    <x-text-input id="tanggal_penerimaan" name="tanggal_penerimaan"
                                                        ...
                                                        class="block w-full border-gray-100 bg-gray-50/30 rounded-2xl focus:bg-white transition-all py-2 text-center font-black group-hover:border-gray-300"
                                                        x-bind:class="currentTheme ? (currentTheme.focus + ' ' + currentTheme.ring) : 'focus:border-rose-500 focus:ring-rose-500'"
                                                        value="{{ old('tanggal_penerimaan', $hcts_receiving->tanggal_penerimaan) }}"
                                                        required />
                                                </div>
                                                <div
                                                    class="group-inner p-3 bg-gray-50/50 rounded-2xl border border-dashed border-gray-200">
                                                    ...
                                                    <x-text-input id="nomor_segel" name="nomor_segel" type="text"
                                                        ...
                                                        value="{{ old('nomor_segel', $hcts_receiving->nomor_segel) }}"
                                                        required />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="lg:col-span-8 space-y-6">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-3 mb-6">
                                                ...
                                                <span
                                                    class="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Spesifikasi
                                                    Detail</span>
                                            </div>
                                                ...
                                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                                    <div>
                                                        ...
                                                        <select id="pecahan" name="pecahan" x-model="selectedPecahan"
                                                            ...
                                                            required>
                                                            <option value="" class="bg-white text-gray-900">Pilih
                                                                Pecahan</option>
                                                    ...
                                                    <div>
                                                        ...
                                                        <select id="gilir" name="gilir"
                                                            class="block w-full border-gray-100 rounded-xl bg-white transition-all py-1.5 text-center font-black shadow-sm"
                                                            ...
                                                            @foreach(['Gilir 1', 'Gilir 2', 'Gilir 3'] as $g)
                                                                <option value="{{ $g }}" {{ old('gilir', $hcts_receiving->gilir) == $g ? 'selected' : '' }}>
                                                                    {{ $g }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <div class="group">
                                                        ...
                                                        <x-text-input id="seri" name="seri" type="text"
                                                            placeholder="Format: AA-AA1" maxlength="6"
                                                            x-model="seriValue" @input="formatSeri($event.target.value)"
                                                ...
                                                <div class="md:col-span-5 space-y-4">
                                                    <div>
                                                        <x-input-label for="jumlah_display" value="Jumlah Bilyet"
                                                            class="text-[11px] font-black uppercase text-rose-600/70 tracking-widest mb-1.5 ml-1"
                                                        ...
                                                        <div class="relative">
                                                            <x-text-input id="jumlah_display" type="text"
                                                                ...
                                                                class="block w-full rounded-2xl focus:border-rose-500 focus:ring-rose-500 font-black transition-all py-2.5 text-center text-xl"
                                                                required />
                                                            <input type="hidden" name="jumlah" x-model="rawJumlah">
                                                            <div
                                                                class="absolute left-6 top-1/2 -translate-y-1/2 text-gray-300 font-black text-[10px] uppercase tracking-widest">
                                                                Bil</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="md:col-span-7 space-y-3">
                                                    <div class="flex justify-between items-end mb-1">
                                                        <div>
                                                            ...
                                                            <p class="text-sm font-black"
                                                                :class="(hcsTotal + (parseInt(rawJumlah) || 0)) > 4500000 ? 'text-rose-600' : 'text-gray-900'">
                                                                <span
                                                                    x-text="new Intl.NumberFormat('id-ID').format(hcsTotal + (parseInt(rawJumlah) || 0))"></span>
                                                        ...
                                                        <div class="text-right">
                                                            ...
                                                            <p class="text-sm font-black text-emerald-500"
                                                                x-text="new Intl.NumberFormat('id-ID').format(Math.max(0, 4500000 - (hcsTotal + (parseInt(rawJumlah) || 0))))">
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="grid grid-cols-2 gap-3">
                                                        <div
                                                            ...
                                                            <span
                                                                class="text-[9px] font-black text-gray-400 uppercase">HCS</span>
                                                            <span class="text-xs font-black text-blue-600"
                                                                x-show="!isLoadingHcs"
                                                                x-text="new Intl.NumberFormat('id-ID').format(hcsTotal)"></span>
                                                            <span
                                                                class="text-[9px] font-black text-blue-400 animate-pulse"
                                                                x-show="isLoadingHcs">...</span>
                                                        </div>
                                                        <div
                                                            class="bg-white/60 px-3 py-2 rounded-xl border border-white/50 shadow-sm flex justify-between items-center">
                                                            <span
                                                                class="text-[9px] font-black text-gray-400 uppercase">HCTS</span>
    ...
    @push('scripts')
        <script>
            function hctsEditData(initialData) {
                return {
