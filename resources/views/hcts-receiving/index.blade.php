                ...
                <div class="p-8 text-gray-900">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                        ...
                        @if(in_array(auth()->user()->role, ['sortir', 'admin']))
                            <a href="{{ route('hcts-receiving.create') }}"
                                class="inline-flex items-center px-4 py-2 bg-rose-600 border border-transparent rounded-lg font-black text-xs text-white uppercase tracking-widest hover:bg-rose-700 transition-all active:scale-95">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                                ...
                                <div
                                    ...
                                    <div class="col-span-2 md:col-span-4 mb-1">
                                        <span
                                            class="text-[9px] font-black uppercase tracking-[0.2em] text-rose-600/50">Periode
                                            & Anggaran</span>
                                    </div>
                                    <div class="col-span-1">
                                        <label
                                            class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5 px-1">Dari</label>
                                    ...
                                    <div class="col-span-1">
                                        <label
                                            class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5 px-1">Sampai</label>
                                    ...
                                    <div class="col-span-1">
                                        <label
                                            class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5 px-1">TA</label>
                                    ...
                                    <div class="col-span-1">
                                        <label
                                            class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5 px-1">Emisi</label>
                                ...
                                <div
                                    ...
                                    <div class="col-span-2 mb-1">
                                        <span
                                            class="text-[9px] font-black uppercase tracking-[0.2em] text-rose-600/50">Spesifikasi</span>
                                    </div>
                                    <div class="col-span-1">
                                        <label
                                            class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5 px-1">Pecahan</label>
                                    ...
                                    <div class="col-span-1">
                                        <label
                                            class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5 px-1">Gilir</label>
                                        <select name="gilir"
                                            class="block w-full border-gray-100 rounded-xl transition-all text-xs py-2.5 font-bold text-center shadow-sm"
                                            :class="currentTheme ? (currentTheme.focus + ' ' + currentTheme.ring) : 'focus:border-rose-500 focus:ring-rose-500'">
                                            <option value="">Semua</option>
                                            <option value="Gilir 1" {{ $gilirFilter == 'Gilir 1' ? 'selected' : '' }}>
                                                Gilir 1</option>
                                            <option value="Gilir 2" {{ $gilirFilter == 'Gilir 2' ? 'selected' : '' }}>
                                                Gilir 2</option>
                                            <option value="Gilir 3" {{ $gilirFilter == 'Gilir 3' ? 'selected' : '' }}>
                                                Gilir 3</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="lg:col-span-4 flex flex-col md:flex-row gap-3 h-full">
                                    <div
                                        ...
                                        <div>
                                            <div class="mb-1">
                                                <span
                                                    class="text-[9px] font-black uppercase tracking-[0.2em] text-rose-600/50">Pencarian</span>
                                            </div>
                                            <label
                                                class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5 px-1">Cari
                                                Data</label>
                                            <input name="search" type="text" value="{{ $search }}"
                                                placeholder="No. Bon, Batch..."
                                    ...
                                    <div class="flex flex-row md:flex-col gap-2 min-w-[120px]">
                                        <button type="submit"
                                            class="flex-1 text-white font-black px-4 py-3 rounded-2xl transition-all active:scale-95 uppercase text-[10px] tracking-widest flex items-center justify-center gap-2"
                                        ...
                                        <a href="{{ route('hcts-receiving.index') }}"
                                            class="flex-1 inline-flex items-center justify-center p-3 bg-white border border-gray-100 rounded-2xl text-gray-400 hover:text-rose-600 transition-all shadow-sm group">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 mb-8">
                        @foreach(['S', 'T', 'U', 'V', 'W', 'X', 'Y'] as $p)
                            ...
                            @endphp
                            <div
                                class="{{ $pData['soft'] }} border {{ $pData['border'] ?? 'border-gray-100' }} rounded-2xl p-4 transition-all hover:shadow-md">
                                <div class="flex items-center justify-between mb-2">
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-black {{ $pData['bg'] }} text-white shadow-sm">{{ $p }}</span>
                                </div>
                                <p class="text-sm font-black text-gray-900 dark:text-white">{{ number_format($totalP, 0, ',', '.') }}</p>
                            </div>
                        @endforeach
                        ...
                        <div class="bg-rose-600 border border-rose-500 rounded-2xl p-4 flex flex-col justify-center">
                            <p class="text-rose-100 text-[9px] font-black uppercase tracking-widest mb-1 leading-none">
                                Total HCTS</p>
                            <p class="text-white text-sm font-black tracking-tight leading-none">
                                            ...
                                            @if(in_array(auth()->user()->role, ['sortir', 'admin']))
                                                <div class="flex justify-center items-center space-x-3 transition-opacity">
                                                    <a href="{{ route('hcts-receiving.edit', $receiving->id) }}"
                                                        class="text-indigo-400 hover:text-indigo-600 transition-colors p-1.5 hover:bg-indigo-50 rounded-lg">
                                                    ...
                                                    <form action="{{ route('hcts-receiving.destroy', $receiving->id) }}"
