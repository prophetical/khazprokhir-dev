            ...
            <form action="{{ route('hcts-submission.store') }}" method="POST" class="space-y-4">
                            ...
                            <div class="p-5 relative">
                                <div class="flex items-center gap-3 mb-4">
                                    <div>
                                        ...
                                        <p class="text-[8px] font-bold text-gray-400  tracking-widest mt-0.5">Penyerahan
                                            HCTS</p>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-3">
                                    <div class="group/input">
                                        ...
                                        <x-text-input id="tanggal_penyerahan" name="tanggal_penyerahan" type="date"
                                            ...
                                            :value="old('tanggal_penyerahan', date('Y-m-d'))" required />
                                    </div>
                                    ...
                                    <div class="group/input">
                                        ...
                                        <x-text-input id="nomor_ba" name="nomor_ba" type="text"
                                            ...
                                            :value="old('nomor_ba')" placeholder="Isi No BA" required />
                                    </div>
                                    ...
                                    <div class="group/input">
                                        ...
                                        <x-text-input id="pemasok1" name="pemasok1" type="text"
                                            ...
                                            :value="old('pemasok1')" oninput="this.value = this.value.toUpperCase()"
                                            required />
                                    </div>
                                    ...
                                    <div class="group/input">
                                        ...
                                        <x-text-input id="pemasok2" name="pemasok2" type="text"
                                            class="block w-full bg-gray-50/50 border-gray-100 focus:bg-white focus:ring-2 focus:ring-rose-500/10 focus:border-rose-500/50 rounded-xl transition-all duration-300 text-md font-bold h-[38px] text-center uppercase"
                                            :value="old('pemasok2')" oninput="this.value = this.value.toUpperCase()" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-5">
                                <div class="flex items-center gap-3 mb-4">
                                    <div>
                                        ...
                                        <p class="text-[8px] font-bold text-gray-400  tracking-widest mt-0.5">Data
                                            Penyerahan HCTS</p>
                                    </div>
                                </div>
                ...
                <div
                    ...
                    <a href="{{ route('hcts-submission.index') }}"
                        class="px-6 py-2.5 text-gray-400 hover:text-gray-900 dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-white/5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all duration-300">
                        {{ __('Batal') }}
                    </a>
                    <button type="submit" :disabled="calculateTotal() != jumlah_bilyet || calculateTotal() === 0"
