            ...
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-2xl mb-8 border border-gray-100 p-1">
                <div class="bg-gray-50/50 rounded-[1.25rem] p-6">
                    <div class="flex flex-col 2xl:flex-row justify-between items-end gap-8">
                        <form action="{{ route('laporan-harian.index') }}" method="GET" class="w-full 2xl:w-auto flex-grow">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
                                <!-- Tanggal Laporan -->
                                <div class="relative">
                                    <label for="tanggal_laporan" class="flex items-center gap-2 text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 px-1">
                                        Tanggal Laporan
                                    </label>
                                ...
                                <!-- Tahun Anggaran -->
                                <div class="relative">
                                    <label for="tahun_anggaran" class="flex items-center gap-2 text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 px-1">
                                        Tahun Anggaran
                                    </label>
                                ...
                                <!-- Tahun Emisi -->
                                <div class="relative">
                                    <label for="tahun_emisi" class="flex items-center gap-2 text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 px-1">
                                        Tahun Emisi
                                    </label>
                        ...
                        <div class="flex flex-col gap-2 w-full 2xl:w-auto">
                            <span class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-0 sm:mb-2 px-1 hidden 2xl:block">&nbsp;</span>
                            <div class="flex flex-wrap gap-3 shrink-0 items-center justify-center sm:justify-end 2xl:justify-start">
                                <!-- Excel -->
