                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-800">
                    <thead class="bg-gray-100/80 dark:bg-slate-800/80">
                        ...
                        <tr
                            ...
                            <th class="x-3 py-1 text-center bg-gray-100 dark:bg-slate-800 italic">k=i/j*100%</th>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-800">
                    <thead class="bg-gray-100/80 dark:bg-slate-800/80">
                        ...
                        <tr
                            ...
                            <th class="x-3 py-1 text-center bg-gray-100 dark:bg-slate-800 italic">g=f/3.000.000</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white dark:bg-slate-900 divide-y divide-gray-100 dark:divide-slate-800">
