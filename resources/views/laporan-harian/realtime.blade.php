<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center justify-start gap-4 sm:gap-6">
            ...
            <div
                class="w-fit px-4 py-1.5 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full flex items-center gap-2 shadow-inner">
    ...
    <div class="py-12" x-data="{ 
        ...
        <div class="w-full mx-auto sm:px-6 lg:px-8 overflow-hidden">
            ...
            <div x-show="loading" x-transition:enter="transition ease-out duration-300"
                ...
                <div
                    class="bg-gray-900/90 backdrop-blur-md text-white px-6 py-3 rounded-full shadow-2xl flex items-center gap-3 border border-white/10">
