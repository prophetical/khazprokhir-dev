...
<body class="font-sans antialiased">
    <div class="min-h-screen flex" style="background: #f0f4ff;">
        ...
        <div class="hidden lg:flex lg:w-1/2 flex-col items-center justify-center relative overflow-hidden p-16"
            ...
            {{-- dekoratif --}}
            <div class="absolute top-0 right-0 w-80 h-80 rounded-full opacity-20 blur-3xl"
                style="background: radial-gradient(circle, #fff 0%, transparent 70%); transform: translate(30%, -30%);">
            </div>
            <div class="absolute bottom-0 left-0 w-96 h-96 rounded-full opacity-20 blur-3xl"
                style="background: radial-gradient(circle, #fff 0%, transparent 70%); transform: translate(-30%, 30%);">
            </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                {{-- Logo di perangkat mobile (hanya ditampilkan pada layar kecil) --}}
