                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('messages.update', $message) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <textarea id="content" name="content" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">{{ old('content', $message->content) }}</textarea>
                            </div>
                            @error('content')
