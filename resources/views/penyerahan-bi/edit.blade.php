                            ...
                            <div>
                                ...
                                <select name="tahun_anggaran" x-model="tahunAnggaran"
                                    ...
                                    @foreach($availableYears as $ta)
                                        <option value="{{ $ta }}" {{ old('tahun_anggaran', $penyerahan->tahun_anggaran) == $ta ? 'selected' : '' }}>{{ $ta }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="tahun_emisi" x-model="tahunEmisi"
                                    ...
                                    @foreach($availableEmissions as $te)
                                        <option value="{{ $te }}" {{ old('tahun_emisi', $penyerahan->tahun_emisi) == $te ? 'selected' : '' }}>{{ $te }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
