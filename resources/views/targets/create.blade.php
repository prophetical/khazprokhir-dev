            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-xl border-t-4 transition-all duration-500"
                ...
                <div class="p-8 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('targets.store') }}">
                        ...
                        {{-- Bagian 1: Identitas & Target Tahunan --}}
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                            ...
                            <div>
                                ...
                                <div class="text-[9px] text-gray-400 mt-1 text-right italic"
                                    x-show="annualTarget > 50000000000">Maksimal 50 Milyar</div>
                            </div>
                        </div>
                        ...
                        {{-- Bagian 2: Target Bulanan Penyerahan --}}
                        ...
                        {{-- Bagian 3: Target Bulanan Pengemasan --}}
                        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-x-6 gap-y-5 mb-10">
                            @foreach($months as $num => $name)
                                <div>
                                    <label
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex flex-col">
                                    <span class="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Selisih
                                        vs Tahunan</span>
                                    <span class="text-xs font-bold"
                                        :class="totalMonthly == annualTarget ? 'text-emerald-500' : 'text-amber-500'">
                                        <span
                                            x-text="totalMonthly == annualTarget ? '✓ Sesuai' : '⚠ Tidak harus sama'"></span>
                                    </span>
                                </div>
                            </div>
