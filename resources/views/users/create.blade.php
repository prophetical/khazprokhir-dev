                    ...
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="mb-8 p-6 bg-indigo-50/50 rounded-xl border border-indigo-100/50" x-data="{ role: '{{ old('role', 'sortir') }}' }">
                            ...
                            <div x-show="role === 'admin'" class="mt-4 p-3 bg-amber-50 rounded-lg border border-amber-200 flex items-center gap-3">
                                ...
                                <span class="text-[10px] text-amber-700 font-bold uppercase tracking-tight leading-none italic">Admin secara otomatis memiliki semua hak akses (Full Access). Konfigurasi granular di bawah akan diabaikan.</span>
                            </div>
                        </div>
