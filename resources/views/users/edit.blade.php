                ...
                <div class="p-8 text-gray-900">
                    <div class="flex justify-between items-center mb-8">
                        <div class="flex flex-col">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Perbarui data user ({{ $user->name }}) dan konfigurasi
                                ulang hak akses.</p>
                        </div>
                    ...
                    <form method="POST" action="{{ route('users.update', $user->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div
                                class="md:col-span-1 border-l-4 border-amber-200 pl-4 bg-amber-50/30 py-2 rounded-r-lg">
                                <label
                        ...
                        <div class="mb-8 p-6 bg-indigo-50/50 rounded-xl border border-indigo-100/50"
                            ...
                            <div x-show="role === 'admin'"
                                ...
                                <span
                                    class="text-[10px] text-amber-700 font-bold uppercase tracking-tight leading-none italic">Role
                                    Admin memintas semua pengecekan izin grid. Konfigurasi di bawah bersifat
                                    cadangan.</span>
                            </div>
                        </div>
