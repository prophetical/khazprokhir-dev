<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <h2 class="font-black text-xl text-gray-800 dark:text-white leading-tight tracking-tight">Hasil Rekap Khazprokhir</h2>
        </div>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {{-- Flash Error --}}
            @if(session('error'))
                <div class="mb-5 p-4 bg-rose-50 dark:bg-rose-900/20 border-l-4 border-rose-500 text-rose-700 dark:text-rose-400 shadow-sm rounded-r-lg flex items-center gap-3">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm overflow-hidden">
                ...
                <div class="p-5 border-b border-gray-100 dark:border-slate-700 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-gray-400 dark:text-slate-500 font-bold">Pilih seri untuk melihat rekapan dashboard gabungan 3 divisi</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-5 py-4 bg-gray-50/50 dark:bg-slate-700/20 border-b border-gray-100 dark:border-slate-700">
                    <form method="GET" action="{{ route('x-pengganti.rekap.index') }}" class="flex flex-wrap gap-3 items-end">
                        {{-- Search --}}
                        ...
                        <a href="{{ route('x-pengganti.rekap.index') }}" class="h-[38px] px-3 bg-white dark:bg-slate-700 border border-gray-200 dark:border-slate-600 text-gray-400 hover:text-rose-600 rounded-xl transition-all flex items-center" title="Reset">
